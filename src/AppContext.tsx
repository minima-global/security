      ...
      (window as any).MDS.init((msg: any) => {
        ...
        if (msg.event === "MDS_SHUTDOWN") {
          if (context === "restore") {
            ...
            setModal({
              content: SuccessDialogRestore.content,
              primaryActions: SuccessDialogRestore.primaryActions,
              secondaryActions: SuccessDialogRestore.secondaryActions,
            });
          }
          if (
            context === "chainresync" ||
