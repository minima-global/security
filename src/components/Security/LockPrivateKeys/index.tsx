            ...
            <div className="core-black-contrast rounded">
              <div>
                <div className="mb-3 text-left pb-2">
                  Locking your private keys prevents unauthorised access to your
                  wallet and seed phrase. Your private keys will be encrypted
                  with a password which you will be required to enter when
                  transacting. You will still be able to receive funds as usual.
                </div>
