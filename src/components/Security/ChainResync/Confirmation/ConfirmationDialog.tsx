          ...
          <section>
            <div className={styles["dialog"]}>
              <div className="flex flex-col align-center">
                ...
                <p className="mb-8">
                  The full chain will be downloaded from your chosen archive
                  node.
                  <br /> <br />
                  This action irreversible, consider taking a backup before
                  starting re-sync.
                  <br /> <br />
                  This process should take up to 2 hours to complete but could
                  take longer. <br />
                  Please connect your device to a power source before
                  continuing.
                </p>
              </div>
