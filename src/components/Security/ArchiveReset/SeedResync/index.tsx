...
const SeedResyncReset = () => {
  ...
  const handlePaste = async (event: React.ClipboardEvent<HTMLInputElement>, setFieldValue: any, validateForm: any, setFieldError: any, setFieldTouched: any) => {
    ...
    if (isPastedTextASeedPhrase) {
      ...
      pastedText.split(" ").forEach((_seed, index) => setFieldValue(`seedPhrase.${index+1}`, ""));

      pastedText.split(" ").forEach((_seed, index) => setFieldValue(`seedPhrase.${index+1}`, _seed.toUpperCase()));
                                    ...
                                    Object.keys(values.seedPhrase).map(
                                      (seed) => (
                                        <li key={`seedInputField_${seed}`} className="relative">
                                          <Autocomplete
                                            onPaste={(e) => handlePaste(e, setFieldValue, validateForm, setFieldError, setFieldTouched)}
            ...
            <div className="mb-4">
              <div className="mb-3 text-left">
                ...
                <ul className="list-disc list-inside mb-4">
                  ...
                  <li className="pl-2.5">An archive file or archive host</li>
                  <li className="pl-2.5">
