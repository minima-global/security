    ...
    <SlideScreen display={true}>
      <div className="flex flex-col h-full bg-black">
        <div className="flex flex-col h-full">
          ...
          <div className="mt-6 text-2xl mb-8 text-left">Manage seed phrase</div>
          <div
          ...
          <div className="flex flex-col gap-5">
            <div className="text-left">
              <div>
                <div className="mb-3">
                  If you have lost your phone or do not have a valid backup, you
                  can import your seed phrase.
                  <br /> <br /> Your wallet and keys will be re-created and all
                  blocks downloaded from an archive node.
                </div>
              </div>
            </div>
