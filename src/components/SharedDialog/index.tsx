...
const SharedDialog = ({ main, primary, secondary, bg = "primary" }: IProps) => {
  let background = "";
  if (bg === "secondary") {
  ...
  return (
    <>
      <div className="h-full bg-black absolute left-0 top-0 bottom-0 right-0 grid grid-cols-[1fr_minmax(0,_560px)_1fr] sm:grid-rows-1">
        <div />
